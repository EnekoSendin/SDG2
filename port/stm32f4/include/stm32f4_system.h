...
/**
 * @brief Lee el valor de un puerto y un pin
 *
 * @param p_port Indica el puerto a modificar.
 * @param pin Indica el pin a modificar.
 * @returns booleano indicando el estado del pin.
 *
 */
bool stm32f4_system_gpio_read(GPIO_TypeDef *p_port, uint8_t pin);

/**
 * @brief Escribe el valor en un puerto y un pin
 *
 * @param p_port Indica el puerto a modificar.
 * @param pin Indica el pin a modificar.
 * @param value Indica el nuevo valor a escribir.
 *
 */
void stm32f4_system_gpio_write(GPIO_TypeDef *p_port, uint8_t pin, bool value);

/**
 * @brief Modifica el valor de un puerto y un pin. (de True a False y viceversa)
 *
 * @param p_port Indica el puerto a modificar.
 * @param pin Indica el pin a modificar.
 *
